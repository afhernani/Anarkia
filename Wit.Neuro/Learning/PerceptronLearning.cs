...
namespace Wit.Neuro.Learning
{
	...
	/// network of <see cref="Wit.Neuro.ActivationNeuron">Activation Neurons</see>
	/// with the <see cref="Wit.Neuro.ThresholdFunction">Threshold</see>
